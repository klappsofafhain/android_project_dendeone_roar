    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1280x960",     "1600x1200",    "1920x1088",    "2048x1152",    "2048x1536",
                "1920x1920",    "2560x1440",    "2576x1932",
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "960x544",
                #else
                "1280x720",     "1080x1080",    "1440x1080",    "1920x1080",    "1680x1260",
                #endif
            )
        ),
    )
   ...
   FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("0"),
            ITEM_AS_USER_LIST_(
                "-30",       //min exposure compensation index
                "30",        //max exposure compensation index
                "0.1",      //exposure compensation step; EV = step x index
            )
        ),
        //......................................................................
        #if 1   //  SCENE HDR
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        KEY_AS_(MtkCameraParameters::KEY_DNG_SUPPORTED),
        SCENE_AS_DEFAULT_SCENE(
            #if GMO_PROJECT //Not support GMO projects with sensor > 8M
            ITEM_AS_DEFAULT_(MtkCameraParameters::FALSE),
            #else
            ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE),
            #endif
