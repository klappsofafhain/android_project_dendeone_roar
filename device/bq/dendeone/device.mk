...
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    ifeq (0x40000000,$(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
        PRODUCT_COPY_FILES += $(LOCAL_PATH)/media_codecs_c2_ago_1g.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_c2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_c2.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml:mtk
endif
...
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    ifeq (0x40000000,$(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
        PRODUCT_COPY_FILES += $(LOCAL_PATH)/media_codecs_mediatek_video_ago_1g.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_google_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_video_le.xml

# media_profiles.xml for media profile support
ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
    ifeq (0x40000000,$(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
        PRODUCT_COPY_FILES += $(LOCAL_PATH)/media_profiles_ago_1g.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
    else ifeq (0x80000000,$(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
